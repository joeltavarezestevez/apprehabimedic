'use strict';
angular.module('app').controller('AppCtrl', ['$scope', '$rootScope', '$http', '$timeout', '$location', 'BASEURL', 'Auth', function($scope, $rootScope, $http, $timeout, $location, BASEURL, Auth) {
        ...
        $scope.app = {            
            name: 'Rehabimedic - Sistema de Facturaci&oacute;n y Control de Terapias',
            version: '3.0.0',
            type: 'hospital',
            color: {
                primary: '#59c2e6',
            ...
            settings: {
                ...
                layoutBoxed: false,
                searchFocus: false,
                pagetitle: 'Rehabimedic - Sistema de Facturaci&oacute;n y Control de Terapias',
            }
        }
