        ...
        $scope.tbOptions = {
            ...
            aoColumns: [
                { mData: 'id' },                              
                {
                    mData: null,
                    bSortable: true,
                    mRender: function (o) { return '<a ng-hide="perfil_usuario!=2 || perfil_usuario!=1" class="text-center" href="#/app/pacientes/perfil/'+ o.paciente.id + '">'+o.paciente.persona.persona_nombres+' '+ o.paciente.persona.persona_apellidos +'</a>'; }
                },   
                {
                    mData: null,
                    bSortable: true,
                ...
                },
                {
                    mData: null,
                    bSortable: false,
                    mRender: function (o) { return '<div class="text-center"><a class="btn btn-xs btn-success" href="#/app/terapias/'+ o.id + '/sesion/nueva" title="Nueva sesión"><i class="fa fa-plus"></i></a></div>'; }
                }
            ]
        }        
    }
        ...
        $scope.tbOptions = {
            ...
            aoColumns: [
                ...
                },
                {
                    mData: null,
                    bSortable: false,
                    mRender: function (o) { return '<div class="text-left"><a class="btn btn-xs btn-success" href="#/app/terapias/'+ o.id + '/sesion/nueva" title="Nueva sesión"><i class="fa fa-plus"></i></a>&nbsp;<button class="btn btn-xs btn-danger ng-click-active" onclick="openModalDeleteTerapias('+ o.id + ')"><i class="fa fa-trash"></i></button></div>'; }
                }
            ]
        }        
    }
